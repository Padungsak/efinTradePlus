...
namespace i2TradePlus.FixForm
{
	public class frmMarketWatch : ClientBaseForm, IRealtimeMessage
	{
		...
		private const string MYGROUP_MY_PORT = "My Port";

		private const string MYGROUP_FAVOURIT = "Favorites";

		private const string MYGROUP_SET = "SET";

		private const string MYGROUP_MAI = "MAI";

		private const string MYGROUP_DERIVATIVE = "Derivative Warrant";

		private const string MYGROUP_WARRANT = "Warrant";

		private const string MYGROUP_CMPR = "%CMPR";

		private const string MYGROUP_FUTURES = "Futures";

		private const string MYGROUP_OPTION = "Option";
		...
		private const string GAINER_PAGE = "Most Active Gainer";

		private const string LOSER_PAGE = "Most Active Loser";

		private const string BLANK_PAGE = "-";
		...
		private DataSet tdsCmpr = null;

		private DataSet tdsMyPort = null;
		...
		private string _lastMAIsel = string.Empty;

		private string _lastDWsel = string.Empty;

		private string _lastWarrantsel = string.Empty;
		...
		private Timer tmBBOSelectionChanged = null;

		private Timer tmBBOSelectionMain = null;
		...
		private bool _isSetMainCombo = false;
				...
				if (ds != null && ds.Tables.Contains("Table"))
				{
					...
					foreach (DataRow dataRow in ds.Tables["Table"].Rows)
					{
						...
						if (num3 > -1)
						{
							...
							long.TryParse(dataRow["iBidQuantity1"].ToString(), out accVolume);
