...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class SaveUserConfigForDumpCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		internal SaveUserConfigForDumpCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
