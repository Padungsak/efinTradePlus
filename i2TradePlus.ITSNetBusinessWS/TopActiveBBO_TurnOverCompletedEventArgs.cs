...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class TopActiveBBO_TurnOverCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		internal TopActiveBBO_TurnOverCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
