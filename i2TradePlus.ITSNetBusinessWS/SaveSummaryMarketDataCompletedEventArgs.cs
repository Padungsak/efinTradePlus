...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class SaveSummaryMarketDataCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		internal SaveSummaryMarketDataCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
