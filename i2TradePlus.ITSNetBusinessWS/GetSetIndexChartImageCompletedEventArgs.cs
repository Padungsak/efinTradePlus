...
namespace i2TradePlus.ITSNetBusinessWS
{
	...
	public class GetSetIndexChartImageCompletedEventArgs : AsyncCompletedEventArgs
	{
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		internal GetSetIndexChartImageCompletedEventArgs(object[] results, Exception exception, bool cancelled, object userState) : base(exception, cancelled, userState)
		{
