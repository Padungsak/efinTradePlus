...
namespace i2TradePlus
{
	public class ucOrderStat : UserControl
	{
		...
		private BackgroundWorker bgwPortStat = null;

		private BackgroundWorker bgwPortStatByStock = null;

		private bool _isInit = false;

		private string _currAccount = string.Empty;

		private DataSet tdsPortStat = null;

		private string _startDate = string.Empty;

		private string _endDate = string.Empty;

		private DataSet tdsPortStatByStock = null;

		private bool isLoadingData = false;

		private Timer tmCloseSplash = null;

		private int _mcPos = 0;
